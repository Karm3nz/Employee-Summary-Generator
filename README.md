...
The usage of the Employee Summary Generator is ...

After installation, the user can follow along with the prompted questions in the command-line until they're given the confirmation that the team.html file is successfully written to. From here, the user can navigate to the "dist" folder to view the generated README.
